...
Lumby roots consist of two functions: `roots` and `lumbyRoots`.
...
library to cut down on the extra boilerplate generated while using zustand selectors. There isn't much boilerplate to begin with, by I wanted to field-test this tool.
